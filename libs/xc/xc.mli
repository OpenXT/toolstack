...
external physdev_map_pirq: handle -> domid -> int -> int
  = "stub_xc_physdev_map_pirq"
external physdev_unmap_pirq: handle -> domid -> int -> unit
  = "stub_xc_physdev_unmap_pirq"
...
external domain_set_xci_cpuid_signature: handle -> domid -> bool -> unit = "stub_xc_domain_set_xci_cpuid_signature"
external domain_set_cores_per_socket: handle -> domid -> int -> unit
       = "stub_xc_domain_set_cores_per_socket"
...
external flask_load : handle -> string -> unit = "stub_xc_flask_load"
external flask_context_to_sid : handle -> string -> int32 = "stub_xc_flask_context_to_sid"
external flask_sid_to_context : handle -> int32 -> string = "stub_xc_flask_sid_to_context"
external flask_get_enforce : handle -> bool = "stub_xc_flask_get_enforce"
external flask_set_enforce : handle -> bool -> unit = "stub_xc_flask_set_enforce"
external flask_add_pirq : handle -> int -> string -> unit = "stub_xc_flask_add_pirq"
external flask_add_ioport : handle -> int64 -> int64 -> string -> unit = "stub_xc_flask_add_ioport"
external flask_add_iomem : handle -> int64 -> int64 -> string -> unit = "stub_xc_flask_add_iomem"
external flask_add_device : handle -> int64 -> string -> unit = "stub_xc_flask_add_device"
external flask_del_pirq : handle -> int -> unit = "stub_xc_flask_del_pirq"
external flask_del_ioport : handle -> int64 -> int64 -> unit = "stub_xc_flask_del_ioport"
external flask_del_iomem : handle -> int64 -> int64 -> unit = "stub_xc_flask_del_iomem"
external flask_del_device : handle -> int64 -> unit = "stub_xc_flask_del_device"
